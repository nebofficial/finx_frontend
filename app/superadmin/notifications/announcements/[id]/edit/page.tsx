...
export default function EditAnnouncementPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    content: 'We will be performing essential system maintenance this Saturday from 2:00 AM to 4:00 AM UTC. During this time, the platform will be unavailable.',
    priority: 'high',
    status: 'published',
  })
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">Update announcement details and delivery settings</p>
        </div>
      </div>
